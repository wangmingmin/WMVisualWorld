//
//  WMMetalVideoShowVC.m
//  WMVisualWorld
//
//  Created by wangmm on 2021/8/18.
//
@import MetalKit;
@import GLKit;
@import AVFoundation;
...
@interface WMMetalVideoShowVC ()<MTKViewDelegate, AVCaptureVideoDataOutputSampleBufferDelegate>
//MTKView
...
@implementation WMMetalVideoShowVC
{
    vector_uint2 _viewportSize;//视图
}
...
//    NSArray *devices = [AVCaptureDevice devicesWithMediaType:AVMediaTypeVideo];
    NSArray *devices = [self getCameraDevices];
...
//        [filter encodeToCommandBuffer:commandBuffer sourceTexture:self.texture destinationTexture:drawingTexture];
        ...
        //边缘检测滤镜
        GLfloat transform[] = {0.5, 0.3, 0.1};
        MPSImageSobel *filter2 = [[MPSImageSobel alloc] initWithDevice:self.mtkView.device linearGrayColorTransform:transform];
        [filter2 encodeToCommandBuffer:commandBuffer sourceTexture:self.texture destinationTexture:drawingTexture];

...
vertexMuchVerShader(uint vertexID [[vertex_id]],
             constant WMVertex *vertices [[buffer(WMVertexInputIndexVertices)]],
...
fragment float4 fragmentMuchVerShader(RasterizerData in [[stage_in]])
{
    //返回输入的片元颜色
    return in.color;
}

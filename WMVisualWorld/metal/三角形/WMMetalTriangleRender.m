...
@implementation WMMetalTriangleRender
{
    //我们用来渲染的设备(又名GPU)
    ...
    //当前视图大小,这样我们才可以在渲染通道使用这个视图，未使用归一化的坐标需要做归一化处理
...
{
    Color color1 = [self makeFancyColor1];
    Color color2 = [self makeFancyColor2];
    Color color3 = [self makeFancyColor3];

    //1. 顶点数据/颜色数据
    WMVertex triangleVertices[] =
    {
        //顶点,    RGBA 颜色值
        { {  0.5, -0.25, 0.0, 1.0 }, { color1.red, color1.green, color1.blue, color1.alpha } },
        { { -0.5, -0.25, 0.0, 1.0 }, { color2.red, color2.green, color2.blue, color2.alpha } },
        { { -0.0f, 0.25, 0.0, 1.0 }, { color3.red, color3.green, color3.blue, color3.alpha } },
    };
...
- (Color)makeFancyColor2
{
    //1. 增加颜色/减小颜色的 标记
    static BOOL       growing = YES;
    //2.颜色通道值(0~3)
    static NSUInteger primaryChannel = 1;
    
    //3.颜色通道数组colorChannels(颜色值)
    static float      colorChannels[] = {0.0, 1.0, 0.0, 1.0};
    //4.颜色调整步长
    const float DynamicColorRate = 0.015;
...
- (Color)makeFancyColor3
{
    //1. 增加颜色/减小颜色的 标记
    static BOOL       growing = YES;
    //2.颜色通道值(0~3)
    static NSUInteger primaryChannel = 2;
    
    //3.颜色通道数组colorChannels(颜色值)
    static float      colorChannels[] = {0.0, 0.0, 1.0, 1.0};
    //4.颜色调整步长
    const float DynamicColorRate = 0.015;

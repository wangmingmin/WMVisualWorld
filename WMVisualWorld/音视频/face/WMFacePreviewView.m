...
@implementation WMFacePreviewView
...
{
    for (CALayer *subLayer in self.faceLayers.allValues) {
        [subLayer removeFromSuperlayer];
    }
    self.faceLayers = [[NSMutableDictionary alloc] init];
}
...
static CATransform3D CATransform3DMakePerspective(CGFloat eyePosition) {
    ...
    //D:eyePosition 观察者到投射面的距离 一般是500~1000.
